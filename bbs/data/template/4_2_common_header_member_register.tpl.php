...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510753637, '2', './data/template/4_2_common_header_member_register.tpl.php', './template/mahjong', 'common/header_member_register')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510753637, '2', './data/template/4_2_common_header_member_register.tpl.php', './template/mahjong', 'common/header_member_register')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510753637, '2', './data/template/4_2_common_header_member_register.tpl.php', './template/mahjong', 'common/header_member_register')
;?>
