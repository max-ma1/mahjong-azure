...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1511362461, '2', './data/template/4_2_common_header_portal_portalcp.tpl.php', './template/mahjong', 'common/header_portal_portalcp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1511362461, '2', './data/template/4_2_common_header_portal_portalcp.tpl.php', './template/mahjong', 'common/header_portal_portalcp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1511362461, '2', './data/template/4_2_common_header_portal_portalcp.tpl.php', './template/mahjong', 'common/header_portal_portalcp')
;?>
