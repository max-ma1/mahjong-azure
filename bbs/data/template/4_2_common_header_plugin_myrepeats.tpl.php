...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1408469215, '2', './data/template/4_2_common_header_plugin_myrepeats.tpl.php', './template/mahjong', 'common/header_plugin_myrepeats')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1408469215, '2', './data/template/4_2_common_header_plugin_myrepeats.tpl.php', './template/mahjong', 'common/header_plugin_myrepeats')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1408469215, '2', './data/template/4_2_common_header_plugin_myrepeats.tpl.php', './template/mahjong', 'common/header_plugin_myrepeats')
;?>
