...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510753504, '2', './data/template/4_2_common_header_forum_post.tpl.php', './template/mahjong', 'common/header_forum_post')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510753504, '2', './data/template/4_2_common_header_forum_post.tpl.php', './template/mahjong', 'common/header_forum_post')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510753504, '2', './data/template/4_2_common_header_forum_post.tpl.php', './template/mahjong', 'common/header_forum_post')
;?>
