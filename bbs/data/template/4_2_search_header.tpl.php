...
0
|| checktplrefresh('./template/mahjong/search/header.htm', './template/mahjong/common/header_common.htm', 1511099552, '2', './data/template/4_2_search_header.tpl.php', './template/mahjong', 'search/header')
;?>
