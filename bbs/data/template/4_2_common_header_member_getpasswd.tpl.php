...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1408464994, '2', './data/template/4_2_common_header_member_getpasswd.tpl.php', './template/mahjong', 'common/header_member_getpasswd')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1408464994, '2', './data/template/4_2_common_header_member_getpasswd.tpl.php', './template/mahjong', 'common/header_member_getpasswd')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1408464994, '2', './data/template/4_2_common_header_member_getpasswd.tpl.php', './template/mahjong', 'common/header_member_getpasswd')
;?>
