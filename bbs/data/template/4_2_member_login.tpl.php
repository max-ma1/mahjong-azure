...
0
|| checktplrefresh('./template/mahjong/member/login.htm', './template/mahjong/common/seccheck.htm', 1510771401, '2', './data/template/4_2_member_login.tpl.php', './template/mahjong', 'member/login')
