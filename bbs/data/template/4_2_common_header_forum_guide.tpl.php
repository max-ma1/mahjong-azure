...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510766918, '2', './data/template/4_2_common_header_forum_guide.tpl.php', './template/mahjong', 'common/header_forum_guide')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510766918, '2', './data/template/4_2_common_header_forum_guide.tpl.php', './template/mahjong', 'common/header_forum_guide')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510766918, '2', './data/template/4_2_common_header_forum_guide.tpl.php', './template/mahjong', 'common/header_forum_guide')
;?>
