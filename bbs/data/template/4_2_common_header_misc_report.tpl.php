...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1501643205, '2', './data/template/4_2_common_header_misc_report.tpl.php', './template/mahjong', 'common/header_misc_report')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1501643205, '2', './data/template/4_2_common_header_misc_report.tpl.php', './template/mahjong', 'common/header_misc_report')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1501643205, '2', './data/template/4_2_common_header_misc_report.tpl.php', './template/mahjong', 'common/header_misc_report')
;?>
