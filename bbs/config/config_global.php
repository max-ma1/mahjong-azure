...
$_config['db']['1']['dbhost'] = 'mahjongsite.mysql.database.azure.com'; //max ma testing
...
$_config['db']['1']['dbname'] = 'mahjong_bbs';
...
$_config['cookie']['cookiepre'] = 'RwgR_';
...
$_config['security']['authkey'] = 'cb47e9IXqsjyAaBh';
