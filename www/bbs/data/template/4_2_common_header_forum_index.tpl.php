...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510752258, '2', './data/template/4_2_common_header_forum_index.tpl.php', './template/mahjong', 'common/header_forum_index')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510752258, '2', './data/template/4_2_common_header_forum_index.tpl.php', './template/mahjong', 'common/header_forum_index')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510752258, '2', './data/template/4_2_common_header_forum_index.tpl.php', './template/mahjong', 'common/header_forum_index')
;?>
