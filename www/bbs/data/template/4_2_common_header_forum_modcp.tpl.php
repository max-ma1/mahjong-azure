...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510810561, '2', './data/template/4_2_common_header_forum_modcp.tpl.php', './template/mahjong', 'common/header_forum_modcp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510810561, '2', './data/template/4_2_common_header_forum_modcp.tpl.php', './template/mahjong', 'common/header_forum_modcp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510810561, '2', './data/template/4_2_common_header_forum_modcp.tpl.php', './template/mahjong', 'common/header_forum_modcp')
;?>
