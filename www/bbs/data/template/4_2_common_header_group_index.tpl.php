...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1419957328, '2', './data/template/4_2_common_header_group_index.tpl.php', './template/mahjong', 'common/header_group_index')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1419957328, '2', './data/template/4_2_common_header_group_index.tpl.php', './template/mahjong', 'common/header_group_index')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1419957328, '2', './data/template/4_2_common_header_group_index.tpl.php', './template/mahjong', 'common/header_group_index')
;?>
