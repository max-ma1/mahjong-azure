...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1498571866, '2', './data/template/4_2_common_header_misc_ranklist.tpl.php', './template/mahjong', 'common/header_misc_ranklist')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1498571866, '2', './data/template/4_2_common_header_misc_ranklist.tpl.php', './template/mahjong', 'common/header_misc_ranklist')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1498571866, '2', './data/template/4_2_common_header_misc_ranklist.tpl.php', './template/mahjong', 'common/header_misc_ranklist')
;?>
