...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1514134337, '2', './data/template/4_2_common_header.tpl.php', './template/mahjong', 'common/header')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1514134337, '2', './data/template/4_2_common_header.tpl.php', './template/mahjong', 'common/header')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1514134337, '2', './data/template/4_2_common_header.tpl.php', './template/mahjong', 'common/header')
;?>
