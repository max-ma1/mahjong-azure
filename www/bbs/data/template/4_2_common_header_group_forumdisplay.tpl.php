...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1524122544, '2', './data/template/4_2_common_header_group_forumdisplay.tpl.php', './template/mahjong', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1524122544, '2', './data/template/4_2_common_header_group_forumdisplay.tpl.php', './template/mahjong', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1524122544, '2', './data/template/4_2_common_header_group_forumdisplay.tpl.php', './template/mahjong', 'common/header_group_forumdisplay')
;?>
