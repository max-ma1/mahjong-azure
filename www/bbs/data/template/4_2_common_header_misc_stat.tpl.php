...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1408385120, '2', './data/template/4_2_common_header_misc_stat.tpl.php', './template/mahjong', 'common/header_misc_stat')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1408385120, '2', './data/template/4_2_common_header_misc_stat.tpl.php', './template/mahjong', 'common/header_misc_stat')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1408385120, '2', './data/template/4_2_common_header_misc_stat.tpl.php', './template/mahjong', 'common/header_misc_stat')
;?>
