...
0
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_common.htm', 1510752617, '2', './data/template/4_2_common_header_home_spacecp.tpl.php', './template/mahjong', 'common/header_home_spacecp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/header_qmenu.htm', 1510752617, '2', './data/template/4_2_common_header_home_spacecp.tpl.php', './template/mahjong', 'common/header_home_spacecp')
|| checktplrefresh('./template/mahjong/common/header.htm', './template/mahjong/common/pubsearchform.htm', 1510752617, '2', './data/template/4_2_common_header_home_spacecp.tpl.php', './template/mahjong', 'common/header_home_spacecp')
;?>
